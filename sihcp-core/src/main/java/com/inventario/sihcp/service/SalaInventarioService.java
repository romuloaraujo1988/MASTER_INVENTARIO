...
public class SalaInventarioService {
     ...
     */
    public List<com.inventario.sihcp.model.SalaInventario> listarPorInventario(int idInventario) {
        try {
     ...
     */
    public List<com.inventario.sihcp.model.SalaInventario> listarPorStatus(int idInventario, String status) {
        try {
