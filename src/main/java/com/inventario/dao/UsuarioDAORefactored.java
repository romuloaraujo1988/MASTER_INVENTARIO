 ...
 */
@Repository
public class UsuarioDAORefactored extends BaseDAO<Usuario, Integer> {
    ...
    protected String getUpdateSQL() {
        return "UPDATE TABELA_USUARIO SET LOGIN = ?, SENHA_HASH = ?, NOME_COMPLETO = ?, " +
               ...
               "PRIMEIRO_ACESSO = ?, OBSERVACOES = ?, UPDATED_AT = CURRENT_TIMESTAMP WHERE ID = ?";
    }
    ...
    protected void setInsertParameters(PreparedStatement stmt, Usuario usuario) throws SQLException {
        ...
        stmt.setObject(7, usuario.getIdSetor());
    ...
    public boolean loginExiste(String login) throws SQLException {
        ...
        Integer count = executeScalar(sql, Integer.class, login);
