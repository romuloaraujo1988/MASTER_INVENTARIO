 ...
 */
public class ImportacaoCSVFrameRefactored extends JFrame {
    ...
    public ImportacaoCSVFrameRefactored() {
        ...
        workerAtual = new SwingWorker<RelatorioImportacao, String>() {
            ...
            protected void done() {
                ...
                try {
                    ...
                    ExceptionHandler.handle(ImportacaoCSVFrameRefactored.this, e, "importar dados");
