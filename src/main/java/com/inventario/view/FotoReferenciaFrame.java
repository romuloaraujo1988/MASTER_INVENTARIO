...
import com.inventario.service.FotoReferenciaService;
import com.inventario.service.FotoReferenciaService.EstatisticasFoto;
import com.inventario.service.FotoReferenciaService.ServiceException;
...
public class FotoReferenciaFrame extends JFrame {
    ...
    private void selecionarImagem() {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            if (arquivo.length() > MAX_FILE_SIZE_BYTES) {
                JOptionPane.showMessageDialog(this,
                    String.format("O arquivo excede o tamanho máximo de %d MB.\n" +
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                ...
                try {
                    if (get()) {
                        JOptionPane.showMessageDialog(FotoReferenciaFrame.this,
                            String.format("Foto salva com sucesso!\n\n" +
                                "Descrição: %s\n" +
    ...
    private void excluirFoto() {
        ...
        int confirmacao = JOptionPane.showConfirmDialog(this,
            String.format("Tem certeza que deseja excluir a foto de referência?\n\n" +
                "Descrição: %s\n" +
