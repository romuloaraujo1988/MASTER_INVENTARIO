...
public class RelatorioExcelGenerator {
    ...
    public boolean gerarRelatorioItensEncontrados(int idInventario, JComponent parent) {
        try {
            System.out.println("Iniciando geração de relatório de itens encontrados para inventário ID: " + idInventario);
            ...
            String[] colunas = {"Patrimônio", "Descrição", "Marca", "Modelo", "Setor", "Responsável", "Estado", "Local de Coleta", "Data Coleta", "Observações"};
            // Usar chaves mais consistentes baseadas no que realmente retorna do DAO
            String[] chaves = {"numero", "descricao", "marca", "modelo", "setor", "responsavel", "estado", "localizacao", "data_coleta", "observacoes"};
            
            String nomeArquivo = "relatorio_itens_encontrados_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioItensNaoEncontrados(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = {"Patrimônio", "Descrição", "Marca", "Modelo", "Setor", "Responsável", "Situação", "Última Localização", "Data Tentativa", "Motivo"};
            String[] chaves = {"numero", "descricao", "marca", "modelo", "setor", "responsavel", "situacao", "ultima_localizacao", "data_tentativa", "motivo"};
            
            String nomeArquivo = "relatorio_itens_nao_encontrados_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioItensSemEtiqueta(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = {"Descrição", "Marca", "Modelo", "Quantidade", "Local", "Responsável", "Estado", "Data Coleta", "Observações"};
            String[] chaves = {"descricao", "marca", "modelo", "quantidade", "local", "responsavel", "estado", "data_coleta", "observacoes"};
            
            String nomeArquivo = "relatorio_itens_sem_etiqueta_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioPorResponsavel(int idInventario, String nomeResponsavel, JComponent parent) {
        try {
            List<Map<String, Object>> dados = relatorioDAO.gerarRelatorioDetalhadoPorResponsavel(idInventario, nomeResponsavel);
            
            String[] colunas = {"Patrimônio", "Descrição", "Marca", "Modelo", "Responsável", "Setor", "Status", "Local de Coleta", "Data Coleta", "Observações"};
            String[] chaves = {"numero", "descricao", "marca", "modelo", "responsavel", "setor", "status_coleta", "localizacao", "data_coleta", "observacao"};
            
            String nomeArquivo = "relatorio_responsavel_" + nomeResponsavel.replaceAll("\\s+", "_") + "_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioItensNaoColetados(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = {"Patrimônio", "Descrição", "Marca", "Modelo", "Setor", "Responsável", "Sala", "Situação", "Valor"};
            String[] chaves = {"Número Patrimônio", "Descrição", "marca", "modelo", "Setor", "Responsável", "Sala", "situacao", "Valor"};
            
            String nomeArquivo = "relatorio_itens_nao_coletados_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioDivergencias(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = {"Patrimônio", "Descrição", "Marca", "Modelo", "Responsável", "Localização Cadastrada", "Localização Encontrada", "Estado Encontrado", "Motivo da Divergência", "Data Coleta", "Observações"};
            String[] chaves = {"Número Patrimônio", "Descrição", "marca", "modelo", "Responsável", "Localização Cadastrada", "Localização Encontrada", "Estado Encontrado", "Motivo da Divergência", "Data Coleta", "Observações"};
            
            String nomeArquivo = "relatorio_divergencias_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioEstatisticas(int idInventario, JComponent parent) {
        try {
            ...
            for (Map<String, Object> estatistica : dados) {
                ...
                celulaDescricao.setCellValue(sanitizarTextoParaExcel(estatistica.get("descricao").toString(), linhaAtual, 0));
            ...
            // Salvar
            String nomeArquivo = "estatisticas_inventario_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
    ...
    public boolean gerarRelatorioGeral(int idInventario, JComponent parent) {
        try {
            ...
            criarAbaRelatorio(workbook, "Itens Encontrados", encontrados, 
                new String[]{"Patrimônio", "Descrição", "Marca", "Modelo", "Setor", "Responsável", "Estado", "Local de Coleta", "Data Coleta", "Observações"}, 
                new String[]{"patrimonio", "descricao", "marca", "modelo", "setor", "responsavel", "estado", "localizacao_encontrada", "data_coleta", "observacoes"});
            ...
            criarAbaRelatorio(workbook, "Não Encontrados", naoEncontrados, 
                new String[]{"Patrimônio", "Descrição", "Marca", "Modelo", "Setor", "Responsável", "Situação", "Última Localização", "Data Tentativa", "Motivo"}, 
                new String[]{"patrimonio", "descricao", "marca", "modelo", "setor", "responsavel", "situacao", "ultima_localizacao", "data_tentativa", "motivo"});
            ...
            criarAbaRelatorio(workbook, "Sem Etiqueta", semEtiqueta, 
                new String[]{"Descrição", "Marca", "Modelo", "Quantidade", "Local", "Responsável", "Estado", "Local de Coleta", "Data Coleta", "Observações"}, 
                new String[]{"descricao", "marca", "modelo", "quantidade", "local", "responsavel", "estado", "localizacao_encontrada", "data_coleta", "observacoes"});
            ...
            // Salvar
            String nomeArquivo = "relatorio_geral_inventario_" + DateFormatUtils.formatForFilename(DateFormatUtils.nowAsDate());
            String caminhoArquivo = System.getProperty("user.home") + "/Desktop/" + nomeArquivo + ".xlsx";
            FileOutputStream fileOut = new FileOutputStream(caminhoArquivo);
            workbook.write(fileOut);
            fileOut.close();
    ...
    private void criarAbaEstatisticas(Workbook workbook, String nomeAba, List<Map<String, Object>> dados) {
        ...
        for (Map<String, Object> linha : dados) {
            ...
            linhaExcel.createCell(0).setCellValue(sanitizarTextoParaExcel(linha.get("descricao").toString(), linhaAtual, 0));
            linhaExcel.createCell(1).setCellValue(sanitizarTextoParaExcel(linha.get("valor").toString(), linhaAtual, 1));
