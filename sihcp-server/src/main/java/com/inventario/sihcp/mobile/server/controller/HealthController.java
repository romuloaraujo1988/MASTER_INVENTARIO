...
import com.inventario.sihcp.config.HikariConnectionPool;
...
public class HealthController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> health() {
        ...
        try {
            // Status do pool
            boolean poolHealthy = HikariConnectionPool.getInstance().isHealthy();
            status.put("database", poolHealthy ? "UP" : "DOWN");
            status.put("poolStats", HikariConnectionPool.getInstance().getPoolStats());
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> poolStatus() {
        ...
        try {
            status.put("healthy", HikariConnectionPool.getInstance().isHealthy());
            status.put("stats", HikariConnectionPool.getInstance().getPoolStats());
            status.put("timestamp", System.currentTimeMillis());
