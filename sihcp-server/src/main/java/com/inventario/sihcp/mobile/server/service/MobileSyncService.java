...
public class MobileSyncService {
    ...
    private final com.inventario.sihcp.service.InventarioService inventarioService;
    private final com.inventario.sihcp.service.SalaService salaService;
    private final com.inventario.sihcp.service.ResponsavelService responsavelService;
    private final com.inventario.sihcp.service.SetorService setorService;
    
    // Usar injeção de dependência do Spring ao invés de ServiceFactory
    public MobileSyncService(
            com.inventario.sihcp.service.InventarioService inventarioService,
            com.inventario.sihcp.service.SalaService salaService,
            com.inventario.sihcp.service.ResponsavelService responsavelService,
            com.inventario.sihcp.service.SetorService setorService) {
    ...
    public Map<String, Object> sincronizacaoCompleta(Integer idInventario) throws SQLException {
        ...
        List<com.inventario.sihcp.model.Sala> salas = salaService.listarTodas();
        ...
        List<com.inventario.sihcp.model.Responsavel> responsaveis = responsavelService.listarTodos();
        ...
        List<com.inventario.sihcp.model.Setor> setores = setorService.listarTodos();
    ...
    private List<Map<String, Object>> simplificarSalas(List<com.inventario.sihcp.model.Sala> salas) {
        return salas.stream()
            .map(this::simplificarSala)
            .collect(Collectors.toList());
    }
    
    private Map<String, Object> simplificarSala(com.inventario.sihcp.model.Sala s) {
        Map<String, Object> map = new HashMap<>();
    ...
    private List<Map<String, Object>> simplificarResponsaveis(List<com.inventario.sihcp.model.Responsavel> responsaveis) {
        return responsaveis.stream()
            .map(this::simplificarResponsavel)
            .collect(Collectors.toList());
    }
    
    private Map<String, Object> simplificarResponsavel(com.inventario.sihcp.model.Responsavel r) {
        Map<String, Object> map = new HashMap<>();
        map.put("id", r.getId());
    ...
    private List<Map<String, Object>> simplificarSetores(List<com.inventario.sihcp.model.Setor> setores) {
        return setores.stream()
            .map(this::simplificarSetor)
            .collect(Collectors.toList());
    }
    
    private Map<String, Object> simplificarSetor(com.inventario.sihcp.model.Setor s) {
        Map<String, Object> map = new HashMap<>();
        map.put("id", s.getId());
