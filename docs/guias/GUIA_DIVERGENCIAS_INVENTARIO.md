...
## ⚠️ Regra Importante: Estados de Conservação

**Estados válidos (conforme legislação federal SIADS):**

| Código | Estado | Descrição |
|--------|--------|-----------|
| 1 | **BOM** | Patrimônio em perfeitas condições de uso |
| 2 | **OCIOSO** | Patrimônio parado, sem uso |
| 3 | **ANTIECONÔMICO** | Patrimônio com custo de manutenção excessivo |
| 4 | **RECUPERÁVEL** | Patrimônio danificado mas recuperável |
| 5 | **IRRECUPERÁVEL** | Patrimônio sem condições de uso ou recuperação |

**Regras de uso:**
- **BOM** = Patrimônio em perfeitas condições (padrão ideal)
- **OCIOSO** = Patrimônio parado, sem uso ativo
- **ANTIECONÔMICO** = Custo de manutenção excessivo
- **RECUPERÁVEL** = Pode ser recuperado com reparos
- **IRRECUPERÁVEL** = Sem condições de uso (dano total)

**Divergência:** Qualquer estado diferente do cadastrado no sistema
...
**Exemplo:**
- **Sistema diz:** BOM
- **Encontrado:** IRRECUPERÁVEL (danificado permanentemente)
- **Divergência:** ✅ SIM

**Estados válidos (SIADS):**
- **BOM** - Perfeitas condições
- **OCIOSO** - Parado, sem uso
- **ANTIECONÔMICO** - Custo excessivo de manutenção
- **RECUPERÁVEL** - Pode ser recuperado
- **IRRECUPERÁVEL** - Dano total, sem recuperação

**Quando marcar:**
- Estado diferente do cadastrado → Divergência
- Patrimônio deteriorado
- Patrimônio danificado
- Patrimônio sem condições de uso
...
2. **Estado diferente do cadastrado**
   ```
   Cadastrado: Estado BOM
   Encontrado: Estado IRRECUPERÁVEL
   → divergencia = TRUE (qualquer estado diferente do cadastrado é divergência)
   ```
