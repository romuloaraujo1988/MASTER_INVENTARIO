...
public abstract class Hilt_ChartsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChartsFragment_GeneratedInjector) this.generatedComponent()).injectChartsFragment(UnsafeCasts.<ChartsFragment>unsafeCast(this));
    }
  }
