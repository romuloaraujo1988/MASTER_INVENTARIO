...
public final class PatrimonioDao_InventarioDatabase_Impl implements PatrimonioDao {
  ...
  @Override
  public Object buscarPorQuery(final String query,
      final Continuation<? super List<PatrimonioEntity>> $completion) {
    final String _sql = "\n"
            + "        SELECT * FROM patrimonio \n"
  ...
  @Override
  public Object buscarColetadosPorQuery(final String query,
      final Continuation<? super List<PatrimonioEntity>> $completion) {
    final String _sql = "\n"
            + "        SELECT * FROM patrimonio \n"
            + "        WHERE (numeroPatrimonio LIKE '%' || ? || '%' \n"
  ...
  @Override
  public Object buscarPendentesPorQuery(final String query,
      final Continuation<? super List<PatrimonioEntity>> $completion) {
    final String _sql = "\n"
            + "        SELECT * FROM patrimonio \n"
            + "        WHERE (numeroPatrimonio LIKE '%' || ? || '%' \n"
  ...
  @Override
  public Object buscarDivergenciasPorQuery(final String query, final int inventarioId,
      final Continuation<? super List<PatrimonioEntity>> $completion) {
    final String _sql = "\n"
