...
public abstract class Hilt_SalaSelectionActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
  ...
  Hilt_SalaSelectionActivity(int p0) {
    super(p0);
    _initHiltInternal();
  }
