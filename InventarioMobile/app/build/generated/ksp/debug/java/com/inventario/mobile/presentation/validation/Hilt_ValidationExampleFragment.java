...
public abstract class Hilt_ValidationExampleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ValidationExampleFragment() {
    super();
  }

  Hilt_ValidationExampleFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ValidationExampleFragment_GeneratedInjector) this.generatedComponent()).injectValidationExampleFragment(UnsafeCasts.<ValidationExampleFragment>unsafeCast(this));
    }
  }
