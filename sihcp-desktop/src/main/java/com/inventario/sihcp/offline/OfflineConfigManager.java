...
public class OfflineConfigManager {
    ...
    /**
     * Verifica se a sincronização automática está habilitada (alias para isAutoSyncEnabled).
     * 
     * @return true se a sincronização automática estiver habilitada
     */
    public boolean isSyncAutomatico() {
    ...
    /**
     * Obtém o intervalo de sincronização em minutos (alias para getSyncIntervalMinutes).
     * 
     * @return Intervalo em minutos
     */
    public int getIntervaloSync() {
        return getSyncIntervalMinutes();
    }
