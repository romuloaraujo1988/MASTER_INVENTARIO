...
import com.inventario.sihcp.offline.OfflineAuthService;
...
public class UnifiedAuthService {
    ...
    private AuthResult autenticarAuto(String login, String senha) {
        ...
        try {
            ...
            LOGGER.warn("Erro na autenticação online - tentando fallback offline: {}", e.getMessage());
    ...
    private AuthResult tentarFallbackOffline(String login, String senha, String mensagemErroOriginal) {
        try {
            ...
            LOGGER.warn("Erro no fallback offline: {}", e.getMessage());
            return AuthResult.failure(mensagemErroOriginal);
        }
    }
    ...
    private AuthResult autenticarOnline(String login, String senha) {
        try {
            ...
            LOGGER.error("Erro na autenticação online: {}", e.getMessage());
    ...
    private AuthResult autenticarOffline(String login, String senha) {
        try {
            ...
            LOGGER.error("Erro na autenticação offline: {}", e.getMessage());
    ...
    private void sincronizarUsuarioParaOffline(Usuario usuario) {
        try {
            ...
            LOGGER.warn("Erro ao sincronizar usuário para offline: {}", e.getMessage());
        }
    }
    ...
    private void ensureOfflineManagerInitialized() {
        try {
            ...
            LOGGER.warn("Erro ao inicializar OfflineManager: {}", e.getMessage());
        }
    }
    ...
    public void criarUsuarioAdminPadrao() {
        ...
        try {
            ...
            LOGGER.warn("Erro ao criar admin no banco online: {}", e.getMessage());
        }
    ...
    public boolean existemUsuariosOffline() {
        try {
            ...
            LOGGER.warn("Erro ao verificar usuários offline: {}", e.getMessage());
            return false;
        }
    }
