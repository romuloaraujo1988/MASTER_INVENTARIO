...
public class RelatorioExcelGenerator {
    ...
    public boolean gerarRelatorioItensEncontrados(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = { "Patrimônio", "Descrição", "Local Cadastrado", "Local Encontrado", "Responsável", "Estado", "Data Coleta" };
            String[] chaves = { "Número Patrimônio", "Descrição", "Sala", "Localização Encontrada", "Responsável", "Estado", "Data Coleta" };
    ...
    public boolean gerarRelatorioItensNaoEncontrados(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = { "Patrimônio", "Descrição", "Marca", "Modelo", "Nota Fiscal", "Setor", "Responsável", "Situação",
                    "Última Localização", "Data Tentativa", "Motivo" };
            String[] chaves = { "Número Patrimônio", "Descrição", "marca", "modelo", "Nota Fiscal", "Setor", "Responsável", "Situação",
                    "Localização Cadastrada", "Data Coleta", "status" };
    ...
    public boolean gerarRelatorioPorResponsavel(int idInventario, String nomeResponsavel, JComponent parent) {
        try {
            ...
            String[] colunas = { "Patrimônio", "Descrição", "Marca", "Modelo", "Nota Fiscal", "Responsável", "Setor", "Status",
                    "Local de Coleta", "Data Coleta", "Observações" };
            String[] chaves = { "numero", "descricao", "marca", "modelo", "nota_fiscal", "responsavel", "setor", "status_coleta",
                    "Localização Encontrada", "data_coleta", "observacao" };
    ...
    public boolean gerarRelatorioItensNaoColetados(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = { "Patrimônio", "Descrição", "Marca", "Modelo", "Nota Fiscal", "Setor", "Responsável", "Sala",
                    "Situação", "Valor" };
            String[] chaves = { "Número Patrimônio", "Descrição", "marca", "modelo", "Nota Fiscal", "Setor", "Responsável", "Sala",
                    "Situação", "Valor" };
    ...
    public boolean gerarRelatorioDivergencias(int idInventario, JComponent parent) {
        try {
            ...
            String[] colunas = { "Patrimônio", "Descrição", "Marca", "Modelo", "Nota Fiscal", "Responsável", "Localização Cadastrada",
                    "Localização Encontrada", "Estado Encontrado", "Motivo da Divergência", "Data Coleta",
                    "Observações" };
            String[] chaves = { "Número Patrimônio", "Descrição", "marca", "modelo", "Nota Fiscal", "Responsável",
    ...
    public boolean gerarRelatorioGeral(int idInventario, JComponent parent) {
        try {
            ...
            criarAbaRelatorio(workbook, "Relatório Completo", completo,
                    new String[] { "Patrimônio", "Descrição", "Local Cadastrado", "Local Encontrado", "Responsável", "Estado", "Data Coleta" },
                    new String[] { "Número Patrimônio", "Descrição", "Sala", "Localização Encontrada", "Responsável", "Estado Encontrado", "Data Coleta" });
            ...
            criarAbaRelatorio(workbook, "Itens Encontrados", encontrados,
                    new String[] { "Patrimônio", "Descrição", "Marca", "Modelo", "Nota Fiscal", "Setor", "Responsável", "Estado",
                            "Local de Coleta", "Data Coleta", "Observações" },
                    new String[] { "Número Patrimônio", "Descrição", "marca", "modelo", "Nota Fiscal", "Setor", "Responsável", "Estado",
