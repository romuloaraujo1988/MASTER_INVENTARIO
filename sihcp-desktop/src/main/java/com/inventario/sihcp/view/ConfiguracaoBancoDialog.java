...
public class ConfiguracaoBancoDialog extends JDialog {
    ...
    private boolean salvarConfiguracaoBancoJson(DatabaseConfig config) {
        try {
            ...
            File jsonFile = new File(configDir, "configuracao_banco.json");
    ...
    private boolean salvarConfiguracaoSGBD() {
        try {
            ...
            com.inventario.sihcp.config.ConfigurationPaths.createConfigDirectoryIfNotExists();
            
            String sgbdConfigPath = com.inventario.sihcp.config.ConfigurationPaths.getSGBDConfigPath();
