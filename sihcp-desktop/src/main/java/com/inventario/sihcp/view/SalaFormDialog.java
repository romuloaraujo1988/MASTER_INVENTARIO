...
public class SalaFormDialog extends JDialog {
    ...
    private JPanel createFormPanel() {
        ...
        cmbSetor.setPreferredSize(new Dimension(10, 30));
    ...
    private JPanel createButtonPanel() {
        ...
        JButton btnCancelar = ButtonStyleFactory.createSecondaryButton("Cancelar");
        btnCancelar.addActionListener(e -> dispose());
        
        JButton btnSalvar = ButtonStyleFactory.createPrimaryButton("Salvar");
    ...
    private void preencherFormulario() {
        ...
        txtAreaM2.setText(sala.getAreaM2() != null ? String.valueOf(sala.getAreaM2()) : "");
