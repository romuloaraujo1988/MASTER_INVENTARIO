...
import com.inventario.sihcp.util.ImportacaoCSV.RelatorioImportacao;
...
public class ImportacaoCSVFrame extends JFrame {
    ...
    private void initializeComponents() {
        ...
        btnCancelar = ButtonStyleFactory.createDangerButton("❌ Cancelar");
        ...
        workerAtual = new SwingWorker<RelatorioImportacao, String>() {
            ...
            protected void done() {
                ...
                try {
                    ...
                    // ✅ Usando ExceptionHandler para erros (captura Throwable para evitar UI travada em caso de Error)
                    ExceptionHandler.handle(ImportacaoCSVFrame.this, new Exception(e), "importar dados");
    ...
    private String gerarRelatorioAjustes() {
        ...
        try {
            ...
            String sqlSemResponsavel = "SELECT COUNT(*) FROM TABELA_PATRIMONIO WHERE ID_RESPONSAVEL IS NULL";
            ...
            String sqlSemSala = "SELECT COUNT(*) FROM TABELA_PATRIMONIO WHERE ID_SALA IS NULL";
            ...
            String sqlSemEstado = "SELECT COUNT(*) FROM TABELA_PATRIMONIO WHERE ESTADO_CONSERVACAO IS NULL OR ESTADO_CONSERVACAO = ''";
    ...
    private void mostrarRelatorioDetalhado(RelatorioImportacao relatorio, String relatorioAjustes) {
        ...
        JButton btnExportar = ButtonStyleFactory.createPrimaryButton("Exportar");
    ...
    private String gerarListaPatrimoniosParaAjuste() {
        ...
        try {
            ...
            String sql = "SELECT numero, descricao FROM TABELA_PATRIMONIO " +
            ...
            sql = "SELECT numero, descricao FROM TABELA_PATRIMONIO " +
