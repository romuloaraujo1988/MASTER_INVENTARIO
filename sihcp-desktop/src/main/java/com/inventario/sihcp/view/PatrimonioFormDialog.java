...
public class PatrimonioFormDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        btnGerarResumo = ButtonStyleFactory.createSmallSuccessButton("Gerar");
        btnGerarResumo.setPreferredSize(new Dimension(80, 25));
    ...
    private void gerarResumoDescricao() {
        ...
        try {
            ...
            String resumo = com.inventario.sihcp.service.DescricaoResumoService.gerarResumo(descricao);
