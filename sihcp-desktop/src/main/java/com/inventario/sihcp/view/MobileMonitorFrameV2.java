...
import com.inventario.sihcp.dto.ConnectedDeviceDTO;
import com.inventario.sihcp.util.MobileApiClient;
...
public class MobileMonitorFrameV2 extends JFrame {
    ...
    private void initializeComponents() {
        ...
        btnAtualizar.setFont(new Font("Segoe UI Emoji", Font.BOLD, 12));
        ...
        btnDetalhes.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 12));
        
        btnDesconectar = new JButton("🔌 Desconectar");
        btnDesconectar.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 12));
