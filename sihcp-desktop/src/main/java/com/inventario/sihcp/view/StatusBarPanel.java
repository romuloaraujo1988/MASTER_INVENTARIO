...
import com.inventario.sihcp.offline.OfflineModeListener;
import com.inventario.sihcp.offline.OfflineModeManager;
import com.inventario.sihcp.service.SyncStatusManager;
...
public class StatusBarPanel extends JPanel implements OfflineModeListener {
    ...
    private void initComponents() {
        ...
        btnSync.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 11));
     ...
     */
    public void atualizarStatus(com.inventario.sihcp.offline.OfflineManager.OfflineState state) {
        switch (state) {
            case ONLINE:
                lblStatus.setText("🟢 ONLINE");
                lblStatus.setForeground(ONLINE_COLOR);
