...
import com.inventario.sihcp.util.RelatorioExcelGenerator;
import com.inventario.sihcp.util.SoundNotification;
...
import com.inventario.sihcp.presentation.viewmodel.RelatorioViewModel;
...
public class RelatorioFrame extends JFrame {
    ...
    // Utilitários
    private com.inventario.sihcp.dao.PatrimonioDAO patrimonioDAO; // Usado apenas para dados de exemplo
    ...
    public RelatorioFrame() {
        ...
        try {
            ...
            this.patrimonioDAO = new com.inventario.sihcp.dao.PatrimonioDAO(); // Apenas para dados de exemplo
    ...
    private JPanel criarAbaPreview() {
        ...
        // Tabela de preview
        String[] colunas = { "Número", "Descrição", "Local Cadastrado", "Local Encontrado", "Responsável", "Estado", "Data Coleta" };
    ...
    private void preencherTabelaComDados(List<Map<String, Object>> dados) {
        ...
        for (Map<String, Object> linha : dados) {
            ...
            // Local Cadastrado (Sala)
            row[2] = linha.get("Sala") != null ? linha.get("Sala")
                    : linha.get("sala") != null ? linha.get("sala")
                    : linha.get("Localização Cadastrada") != null ? linha.get("Localização Cadastrada") : "N/A";

            // Local Encontrado (Localização Encontrada)
            row[3] = linha.get("Localização Encontrada") != null ? linha.get("Localização Encontrada")
                    : linha.get("localizacao") != null ? linha.get("localizacao") : "N/A";

            // Responsável
            row[4] = linha.get("Responsável") != null ? linha.get("Responsável") : linha.get("responsavel");

            // Estado de Conservação
            row[5] = linha.get("Estado") != null ? linha.get("Estado")
            ...
            // Data da Coleta
            Object dataColeta = linha.get("Data Coleta") != null ? linha.get("Data Coleta")
                    : linha.get("data_coleta") != null ? linha.get("data_coleta") : "";
            row[6] = dataColeta != null ? dataColeta.toString() : "";
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                ...
                protected Void doInBackground() throws Exception {
                    try {
                        ...
                        com.inventario.sihcp.util.RelatorioPDFGenerator.gerarRelatorioPDF(
