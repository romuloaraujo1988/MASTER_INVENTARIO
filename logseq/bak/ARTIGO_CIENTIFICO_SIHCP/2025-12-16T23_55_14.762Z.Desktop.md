...
### 6.4 Comparativo com Literatura: Processo Manual vs Digital

Na ausência de dados históricos do processo manual no IFMT, utilizou-se como referência estudos da literatura sobre digitalização de processos de inventário em instituições públicas:

| Métrica | Processo Manual (Literatura) | Sistema SIHCP | Referência |
|---------|------------------------------|---------------|------------|
| Tempo por item | 1,5 a 3 minutos | 8-32 segundos | Oliveira e Santos (2019) |
| Taxa de erro de transcrição | 10-20% | N/A (sem transcrição) | Silva et al. (2020) |
| Taxa de duplicatas | 5-12% | 0,12% (observado) | Ferreira (2018) |
| Produtividade (itens/dia) | 50-100 itens | 250-400 itens* | Costa e Lima (2021) |

*Estimativa baseada no tempo médio observado e jornada de 6 horas efetivas.
